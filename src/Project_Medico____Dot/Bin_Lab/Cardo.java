 ...
 * @author USER
 */
public class Cardo extends javax.swing.JFrame {

    /**
     * Creates new form Cardo
     */
    public Cardo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cardo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
